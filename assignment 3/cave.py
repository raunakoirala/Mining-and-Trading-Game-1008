...
class Cave:
    ...
    def __init__(self, name: str, material: Material, quantity: int=0) -> None:
        """
        Initialises the constructor for Cave

        Parameters:
                name(string): name of the cave
                material (Material): material within the cave
                quantity (int): quantity of material
        Returns:
                None
    ...
    def add_quantity(self, amount: float) -> None:
        """
        Increases amount of material by a given amount

        Parameters:
                amount(float): Amount to add to quantity
    ...
    def remove_quantity(self, amount: float) -> None:
        """
        Decrease amount of material by a given amount

        Parameters:
                amount(float): Amount to remove from quantity
    ...
    def get_quantity(self) -> float:
        """
        Gets the quantity value of the material within the cave
    ...
    def __str__(self) -> str:
        """
        Returns the cave details as a formatted string

        Returns:
                output (str): cave name, material and quantity

        Worst case complexity: O(1)
        Best Case complexity: O(1)
        """
        return self.name + " " + str(self.material) + " " + str(self.quantity)

    @classmethod
    def random_cave(cls, material_list: list[Material]) -> Cave:
        """
        Returns the cave randomly created

        Parameters:
                material_list(list of given materials)
        ...
        Best Case complexity: O(1)
        """
        return Cave(CAVE_NAMES[RandomGen.randint(0,len(CAVE_NAMES)-1)], material_list[RandomGen.randint(0,len(material_list)-1)], RandomGen.randint(1,10))
